...
Route::get('/searchFriends/{string?}', 'FriendsController@showSearch');
Route::post('/searchFriends/{string?}', 'FriendsController@showSearch');
Route::post('/findFriends/{string}', 'FriendsController@showSearch');
